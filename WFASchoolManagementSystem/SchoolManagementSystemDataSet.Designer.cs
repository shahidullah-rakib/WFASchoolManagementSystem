...
namespace WFASchoolManagementSystem {
    ...
    public partial class SchoolManagementSystemDataSet : global::System.Data.DataSet {
        ...
        public partial class UserDataTable : global::System.Data.TypedTableBase<UserRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public UserRow AddUserRow(string userId, string password, string type) {
...
namespace WFASchoolManagementSystem.SchoolManagementSystemDataSetTableAdapters {
    ...
    public partial class UserTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[User] WHERE (([userId] = @Original_userId) AND ((@IsNull_passw" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[User] ([userId], [password], [type]) VALUES (@userId, @passwor" +
                "d, @type);\r\nSELECT userId, password, type FROM [User] WHERE (userId = @userId)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[User] SET [userId] = @userId, [password] = @password, [type] = @type WHERE (([userId] = @Original_userId) AND ((@IsNull_password = 1 AND [password] IS NULL) OR ([password] = @Original_password)) AND ((@IsNull_type = 1 AND [type] IS NULL) OR ([type] = @Original_type)));
SELECT userId, password, type FROM [User] WHERE (userId = @userId)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::WFASchoolManagementSystem.Properties.Settings.Default.SchoolManagementSystemConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT userId, password, type FROM dbo.[User]";
        ...
        public virtual int Fill(SchoolManagementSystemDataSet.UserDataTable dataTable) {
        ...
        public virtual SchoolManagementSystemDataSet.UserDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            SchoolManagementSystemDataSet.UserDataTable dataTable = new SchoolManagementSystemDataSet.UserDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(SchoolManagementSystemDataSet.UserDataTable dataTable) {
        ...
        public virtual int Delete(string Original_userId, string Original_password, string Original_type) {
        ...
        public virtual int Insert(string userId, string password, string type) {
            if ((userId == null)) {
        ...
        public virtual int Update(string userId, string password, string type, string Original_userId, string Original_password, string Original_type) {
            if ((userId == null)) {
                throw new global::System.ArgumentNullException("userId");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string password, string type, string Original_userId, string Original_password, string Original_type) {
            return this.Update(Original_userId, password, type, Original_userId, Original_password, Original_type);
        }
    }
